...
const FileUpload: React.FC<FileUploadProps> = ({ fileType = "image" }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4 border rounded-lg w-full max-w-md mx-auto bg-white shadow-md">
      <input
        type="file"
